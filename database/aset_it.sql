...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2026 at 03:36 PM
...
INSERT INTO `aset` (`id_aset`, `kode_aset`, `nama_aset`, `id_kategori`, `spesifikasi`, `id_lokasi`, `kondisi`, `status`, `tgl_perolehan`, `keterangan`, `foto_aset`) VALUES
(24, 'AST-001                                                                ', 'Acer                                                                                                                                                                                                                                                           ', 7, '-', 33, 'rusak ringan', 'cadangan', '2026-07-15', '-', 'default.jpg'),
(25, 'AST-002                                                                ', 'Printer Cannon', 9, '-', 34, 'baik', 'aktif', '2026-07-22', '-', 'default.jpg'),
(26, 'AST-003                                                                ', 'Router Tenda', 8, '-', 33, 'rusak berat', 'cadangan', '2026-07-22', '-', 'default.jpg');
...
(2, 'Afi', 'afiproject80@gmail.com', '$2a$12$.FnHHCRiyViqqhtnZrlzJun16syeFEkZMZGTYKMlXNIwa7JkHZvV2', 'Affi', 'admin', '6a60b5484c16f.jpg');
...
--
ALTER TABLE `aset`
  MODIFY `id_aset` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
